...
namespace kinematic_viewer {
    ...
    bool KinematicIkController::EnsureMarkerTargetInitialized(omnilink::teleop_viewer::RobotScene* scene, int chain_index) {
    ...
    bool KinematicIkController::LoadActiveMarkerFromTarget(omnilink::teleop_viewer::RobotScene* scene) {
    ...
    bool KinematicIkController::ApplyIkForActiveChain(omnilink::teleop_viewer::RobotScene* scene, bool force_orientation_lock,
    ...
    bool KinematicIkController::RefineActiveChainToMarker(omnilink::teleop_viewer::RobotScene* scene) {
        if (!ik_state_ || !scene || ik_state_->selected_chain < 0 ||
            ik_state_->selected_chain >= static_cast<int>(ik_state_->chains.size())) {
            return false;
        }
    ...
    float KinematicIkController::ActiveChainPositionErrorMmToMarker(omnilink::teleop_viewer::RobotScene* scene) const {
        if (!ik_state_ || !scene || ik_state_->selected_chain < 0 ||
            ik_state_->selected_chain >= static_cast<int>(ik_state_->chains.size())) {
            return 0.0f;
        }
    ...
    void KinematicIkController::ApplyExternalTarget(omnilink::teleop_viewer::RobotScene* scene) {
